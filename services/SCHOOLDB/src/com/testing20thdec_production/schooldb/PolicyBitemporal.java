...
/**
 * PolicyBitemporal generated by WaveMaker Studio.
 */
@TableTemporal(value = {TableTemporal.TemporalType.SYSTEM, TableTemporal.TemporalType.APPLICATION})
@Entity
@Table(name = "`POLICY_BITEMPORAL`")
public class PolicyBitemporal implements Serializable {
    ...
    @Column(name = "`TRANS_START`", nullable = false, insertable = false, updatable = false)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyBitemporal)) return false;
        final PolicyBitemporal policyBitemporal = (PolicyBitemporal) o;
        return Objects.equals(getId(), policyBitemporal.getId());
    }
