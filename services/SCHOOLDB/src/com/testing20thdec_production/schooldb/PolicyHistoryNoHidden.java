...
/**
 * PolicyHistoryNoHidden generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`POLICY_HISTORY_NO_HIDDEN`")
public class PolicyHistoryNoHidden implements Serializable {
    ...
    @Column(name = "`TRANS_START`", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicyHistoryNoHidden)) return false;
        final PolicyHistoryNoHidden policyHistoryNoHidden = (PolicyHistoryNoHidden) o;
        return Objects.equals(getId(), policyHistoryNoHidden.getId());
    }
